//==============================================================================
// AoMYai.xs Version 1.01
//
//This is the default AOM XPack AI script code for Computer Player AI players.
// Do not use it directly, use an aomyloader*.xs file to load it.
//==============================================================================
...
extern int	gBuilder = -1;
extern int 	gGatherer = -1;
extern int 	gNativeMaxVillagers = 30;
extern int  gNativeVillMaintainPlanID = -1;
//extern int 	 gVillager = cUnitTypeVillagerGreek;
//extern int	 gBuilder  = gBuilder
...
//==============================================================================
//The Natives Expansion
//==============================================================================
mutable int createResearchPlan (int techID =-1, int researchAtID=-1,int researchPri=-1,int escrowID=-1){}
...
// void initProgress()
include "aomyaiProg.xs";

//==============================================================================
//Military Include.
include "aomyaiMil.xs";
   ...
   bool military=false, bool economy=true, int escrowID=-1, int baseID=-1, int numberBuilders=1)
{
   ...
   for (i=0; < number)
   {
      ...
      //Builders.
	   aiPlanAddUnitType(planID, gBuilder,
...
*/
   ...
   aiPlanSetVariableInt(gNativeVillMaintainPlanID, cTrainPlanNumberToMaintain, 0, vilPop);
}
...
void initGreek(void)
{
   ...
   if (cMyCiv == cCivZeus)
   {
/*		int Random3=aiRandInt(3); // I have made a comepletely new rule to ensure our civs get picked
		int researchBuilding = findUnit(cMyID, cUnitStateAlive, cUnitTypeStatueofMajorGodStarting);
		int researchTech = -1;
		
		switch(Random3)
		{
			case 0: {researchTech = cTechAge1ZeusComplete; break;}
			case 1: {researchTech = cTechAge1Hades; break;}
			case 2: {researchTech = cTechAge1Poseidon; break;}
		}
		
		aiTaskUnitResearch(researchBuilding, researchTech);
		aiEcho("Getting our major god: "+kbGetTechName(researchTech)+".");
*/	
/*
         switch(Random3)
         {
         case 0:
            {
			  int a = -1;
			  a = aiPlanCreate("GetAge1UpgradeGreek", cPlanResearch);
			  aiPlanSetVariableInt(a, cResearchPlanTechID, 0, cTechAge1ZeusComplete);
			  aiPlanSetDesiredPriority(a, 90);
			  aiPlanSetActive(a);
			  aiEcho("Getting first Age upgrade - Zeus");
			  break;
            }
         case 1:
            {
			  int b = -1;
			  b = aiPlanCreate("GetAge1UpgradeGreek", cPlanResearch);
			  aiPlanSetVariableInt(b, cResearchPlanTechID, 0, cTechAge1Hades);
			  aiPlanSetDesiredPriority(b, 90);
			  aiPlanSetActive(b);
			  aiEcho("Getting first Age upgrade - Hades");
			  break;
            }
         case 2:
            {
			  int c = -1;
			  c = aiPlanCreate("GetAge1UpgradeGreek", cPlanResearch);
			  aiPlanSetVariableInt(c, cResearchPlanTechID, 0, cTechAge1Poseidon);
			  aiPlanSetDesiredPriority(c, 90);
			  aiPlanSetActive(c);
			  aiEcho("Getting first Age upgrade - Poseidon");
			  break;
            }
         }
...
/*int Random3=aiRandInt(3);
	...
	switch(Random3)
	{
		...
		{
			int a = -1;
			a = aiPlanCreate("GetAge1UpgradeEgyptian", cPlanResearch);
			aiPlanSetVariableInt(a, cResearchPlanTechID, 0, cTechAge1IsisComplete);
			aiPlanSetDesiredPriority(a, 90);
			aiPlanSetActive(a);
			aiEcho("Getting first Age upgrade");
			break;
		}
		case 1:
		{
			int b = -1;
			b = aiPlanCreate("GetAge1UpgradeGreek", cPlanResearch);
			aiPlanSetVariableInt(b, cResearchPlanTechID, 0, cTechAge1Ra);
			aiPlanSetDesiredPriority(b, 90);
			aiPlanSetActive(b);
			break;
			aiEcho("Getting first Age upgrade");
		...
		case 2:
		{
			int c = -1;
			c = aiPlanCreate("GetAge1UpgradeGreek", cPlanResearch);
			aiPlanSetVariableInt(c, cResearchPlanTechID, 0, cTechAge1Set);
			aiPlanSetDesiredPriority(c, 90);
			aiPlanSetActive(c);
			break;
			aiEcho("Getting first Age upgrade");
...
void initNorse(void)
{
   ...
   //Set our trained dropsite PUID. Only for non-natives (Thor is native now)
...
/*int Random3=aiRandInt(3);
	...
	switch(Random3)
	{
		...
		{
			int a = -1;
			a = aiPlanCreate("GetAge1UpgradeNatives", cPlanResearch);
			aiPlanSetVariableInt(a, cResearchPlanTechID, 0, cTechAge1Wiracocha);
			aiPlanSetDesiredPriority(a, 90);
			aiPlanSetActive(a);
			break;
			aiEcho("Getting first Age upgrade");
		...
		{
			int b = -1;
			b = aiPlanCreate("GetAge1UpgradeNatives", cPlanResearch);
			aiPlanSetVariableInt(b, cResearchPlanTechID, 0, cTechAge1Itzamna);
			aiPlanSetDesiredPriority(b, 90);
			aiPlanSetActive(b);
			break;
			aiEcho("Getting first Age upgrade");
		...
		{
			int c = -1;
			c = aiPlanCreate("GetAge1UpgradeNatives", cPlanResearch);
			aiPlanSetVariableInt(c, cResearchPlanTechID, 0, cTechAge1Huitzilopochtli);
			aiPlanSetDesiredPriority(c, 90);
			aiPlanSetActive(c);
			break;
			aiEcho("Getting first Age upgrade");
...
*/
 ...
 /*        switch(Random3)
         ...
         case 0:
            {
      int d = -1;
      d = aiPlanCreate("GetAge1UpgradeENorse", cPlanResearch);
      aiPlanSetVariableInt(d, cResearchPlanTechID, 0, cTechAge1OdinComplete);
      aiPlanSetDesiredPriority(d, 90);
      aiPlanSetActive(d);
      xsDisableSelf();
      aiEcho("Getting first Age upgrade");
            }
         case 1:
            {
      int e = -1;
      e = aiPlanCreate("GetAge1UpgradeNorse", cPlanResearch);
      aiPlanSetVariableInt(e, cResearchPlanTechID, 0, cTechAge1Thor);
      aiPlanSetDesiredPriority(e, 90);
      aiPlanSetActive(e);
      xsDisableSelf();
      aiEcho("Getting first Age upgrade");
            }
         case 2:
            {
      int f = -1;
      f = aiPlanCreate("GetAge1UpgradeNorse", cPlanResearch);
      aiPlanSetVariableInt(f, cResearchPlanTechID, 0, cTechAge1Loki);
      aiPlanSetDesiredPriority(f, 90);
      aiPlanSetActive(f);
      xsDisableSelf();
      aiEcho("Getting first Age upgrade");
            }
...
void initNative(void)
{
	...
	kbTechTreeAddDropsiteUnitIDByResource(cResourceFood);
	
	aiEcho("initNative");
	
	gBuilder = cUnitTypeVillagerAmericanNative;
	gNativeVillMaintainPlanID = maintainUnit(cUnitTypeVillagerAmericanNative, gNativeMaxVillagers);
	
//	xsEnableRule("replace");
	
	gLandScout = cUnitTypeShaman;
	gAirScout = -1;
//	gWaterScout = cUnitTypeAnFishingShip;
	gWaterScout = -1;

	int exploreID=aiPlanCreate("Explore_SpecialNative", cPlanExplore);
	if (exploreID >= 0)
	{
		aiPlanAddUnitType(exploreID, cUnitTypeLogicalTypeLandMilitary, 1, 1, 1);
		aiPlanSetActive(exploreID);
	}
}
...
void init(void)
{
	...
	xsEnableRule("AORWmainChecker");
	xsEnableRule("chooseAge1God");
   ...
   aiEcho("Dropsite for gold: "+kbTechTreeGetDropsiteUnitIDByResource(cResourceGold,0)+"");
   aiEcho("Dropsite for food: "+kbTechTreeGetDropsiteUnitIDByResource(cResourceFood,0)+"");
   aiEcho("Dropsite for wood: "+kbTechTreeGetDropsiteUnitIDByResource(cResourceWood,0)+"");
...
*/
      ...
      aiEcho("Making nomad explore plans.");
	   ...
	   {
         aiPlanAddUnitType(gNomadExplorePlanID1, gBuilder, 1, 1, 1);
	   ...
	   {
         aiPlanAddUnitType(gNomadExplorePlanID2, gBuilder, 1, 1, 1);
      ...
      gNomadExplorePlanID3=aiPlanCreate("Nomad Explore 3", cPlanExplore);
	   ...
	   {
         aiPlanAddUnitType(gNomadExplorePlanID3, gBuilder, 1, 2, 2);   // Grab last Egyptian
...
minInterval 1
{
   ...
   if (builderQuery < 0)
   {
      ...
      kbUnitQuerySetUnitType(builderQuery, gBuilder);
   ...
   aiPlanSetVariableInt(gNomadSettlementBuildPlanID, cGoalPlanUnitTypeID, 0, gBuilder);
...
//EnableRule("buildSettlements");
   ...
   //Builders.
	aiPlanAddUnitType(gNomadSettlementBuildPlanID, gBuilder, 4, 4, 4);
   //Base ID.
   aiPlanSetBaseID(gNomadSettlementBuildPlanID, kbBaseGetMainID(cMyID));
...
void age2Handler(int age=1)
{
   ...
   xsEnableRule("defendPlanRule");
	...
	if (iAmNative())
	{
		gNativeMaxVillagers = 40;
		aiPlanSetVariableInt(gNativeVillMaintainPlanID, cTrainPlanNumberToMaintain, 0, gNativeMaxVillagers);
	}
   //Econ.
   econAge2Handler(age);
   //Progress.
   ...
   else if (cMyCulture == cCultureNorse)
   {
      ...
      if (longhousePlanID >= 0)
      {
         ...
         aiPlanSetDesiredPriority(longhousePlanID, 100);
		   aiPlanAddUnitType(longhousePlanID, gBuilder,
   ...
   else if (cMyCulture == cCultureAtlantean)
   {
      ...
      if (guildPlanID >= 0)
      {
         ...
         aiPlanSetDesiredPriority(guildPlanID, 100);
		   aiPlanAddUnitType(guildPlanID, gBuilder,
            gBuildersPerHouse, gBuildersPerHouse, gBuildersPerHouse);
...
/*old
      ...
      if (gWallPlanID != -1)
      {
         ...
         aiPlanAddUnitType(gWallPlanID, gBuilder, 1, 1, 1);
         ...
         if (cMyCulture != cCultureAtlantean)      // Two extra one-vill wall plans let them leapfrog...faster wall construction
         {
            ...
            aiPlanAddUnitType(wallPlanID2, gBuilder, 1, 1, 1);
            ...
            aiPlanAddUnitType(wallPlanID3, gBuilder, 1, 1, 1);
...
*/
      ...
      */
      ...
      aiPlanAddUnitType(gWallPlanID, gBuilder, 1, 3, 3);
      if (cMyCulture == cCultureAtlantean)
         aiPlanAddUnitType(gWallPlanID, gBuilder, 1, 1, 1);
...
minInterval 10
{
   ...
   if (marketPlanID >= 0)
   {
      ...
      aiPlanSetDesiredPriority(marketPlanID, 100);
		aiPlanAddUnitType(marketPlanID, gBuilder, 1, 1, 1);
...
//      builtMarket = false;    // It's been 5 minutes, and I still don't have a market.
   ...
   if (builtMarket == false)
   {
      ...
      aiPlanAddUnitType(buildPlanID, gBuilder, 1, 1, 1);
...
void age3Handler(int age=2)
{
      ...
      if (aiGetWorldDifficulty() != cDifficultyEasy)
      {
         ...
         if (fortressPlanID >= 0)
         {
            ...
            aiPlanSetDesiredPriority(fortressPlanID, 100);
		      aiPlanAddUnitType(fortressPlanID, gBuilder, 1, 1, 1);
      ...
      if (aiGetWorldDifficulty() != cDifficultyEasy)
      {
         ...
         if (siegeCampPlanID >= 0)
         {
            ...
            aiPlanSetDesiredPriority(siegeCampPlanID, 100);
		      aiPlanAddUnitType(siegeCampPlanID, gBuilder, 1, 1, 1);
   ...
   if (strongBuildPlanID >= 0)
   {
      ...
      aiPlanSetDesiredPriority(strongBuildPlanID, 90);
		aiPlanAddUnitType(strongBuildPlanID, gBuilder,
   ...
   inactive
{
   ...
   if (buildingID >= 0)
   {
      ...
      aiPlanAddUnitType(planID, gBuilder, 1, 1, 5);
      if (cMyCulture == cCultureAtlantean)
         aiPlanAddUnitType(planID, gBuilder, 1, 1, 1);
      aiPlanSetActive(planID);
   }
}
...
/*old
   ...
   if (wallPlanID != -1)
   {
      ...
      aiPlanAddUnitType(wallPlanID, gBuilder, 1, 1, 1);
...
//         return;
      ...
      aiPlanSetEscrowID(remotePlanID, cMilitaryEscrowID);
	   aiPlanAddUnitType(remotePlanID, gBuilder, 1, 1, 1);
...
bool builtTemplePossible()
{
	if (cMyCulture == cCultureEgyptian)
	{
		if (kbResourceGet(cResourceGold) < 100)
			return(false);
	}
else
	{	// All other cultures have to pay wood in addition
		if ((kbResourceGet(cResourceGold) < 100) || (kbResourceGet(cResourceWood) < 100))
			return(false);
	}
...
inactive
{
	...
	aiEcho("-");
	aiEcho("Enabling normal resouce breakdown. My age = "+myAge+".");
	aiEcho("- enableNormalEconomics");
...
// Age one research workaround
rule AORWmainChecker
minInterval 5
inactive
{
	// If we aren't in age 1, then go away.
	if (kbGetAge() > cAge2)
	{
		aiEcho("We are not in age 1. Disabling");
		aiEcho("- AORWmainChecker");
		xsDisableSelf();	
		return;
	}
	...
	{
		// We have none.
		// But do we have resources to build one?
		if (builtTemplePossible() == true)
		{
			xsEnableRule("AORWbuildTemple");
			aiEcho("We do not have a temple - let's build one.");
			xsDisableSelf();
		}
		else
			{return; aiEcho("We do not have a temple - we can't afford one either.");}
	}
	else
	{
		// We have one or more - go straight to technology
		xsEnableRule("AORWresearchTechnology");
		aiEcho("We have one or more temples - go straight to technology");
		xsDisableSelf();
	}
}
rule AORWbuildTemple 
inactive 
{
	xsSetRuleMinIntervalSelf(5);
	
	// This variable is only defined once
	static int buildPlanID = -1;
	
	// Kill ourselves we already have a temple
	if (kbUnitCount(cMyID, cUnitTypeTemple, cUnitStateAlive) >= 1)
		{
			xsEnableRule("AORWresearchTechnology"); 
	...
	// Setup a plan
	 buildPlanID=aiPlanCreate("Force Temple Build", cPlanBuild);
		if (buildPlanID > 0)
		{
			aiPlanSetVariableInt(buildPlanID, cBuildPlanBuildingTypeID, 0, cUnitTypeTemple);
			aiPlanSetVariableInt(buildPlanID, cBuildPlanNumAreaBorderLayers, 2, kbAreaGetIDByPosition(kbBaseGetLocation(cMyID, kbBaseGetMain(cMyID))));
			aiPlanSetDesiredPriority(buildPlanID, 250);
			aiPlanAddUnitType(buildPlanID, gBuilder, 1, 2, 3);
			aiPlanSetBaseID(buildPlanID, kbBaseGetMain(cMyID));
			aiEcho("Temple build plan made");
...
rule AORWresearchTechnology 
minInterval 2
inactive
{
	xsSetRuleMinIntervalSelf(2);
	
	static int technologyID = -1;
	int a = -1;
	int b = -1;
	
	// Wait till we have enough resources.
	if (kbResourceGet(cResourceFood) < 400)
		return;
	
	// If we no longer in age 1, kill this plan
	if (kbGetAge() > cAge1)
	{
		aiEcho("We are not in age 1. Disabling");
		aiEcho("- AORWresearchTechnology");
		xsDisableSelf();	
		return;
	}
	
	if ((kbGetTechStatus(technologyID) == cTechStatusResearching) || (kbGetTechStatus(technologyID) == cTechStatusPersistent))
		{aiEcho("The tech "+kbGetTechName(technologyID)+" is currently being researched."); return;}
		...
		aiEcho("technologyID = "+kbGetTechName(technologyID)+" a = "+kbGetTechName(a)+" b = "+kbGetTechName(b)+".");
		aiTaskUnitResearch(findUnit(cMyID, cUnitStateAlive, cUnitTypeSettlementLevel1), technologyID);
		// Check again in a 60 seconds
		xsSetRuleMinIntervalSelf(10);
		aiEcho("AORWresearchTechnology - Checking again in 10 seconds");
		aiEcho("AORWresearchTechnology - Status is "+kbGetTechStatus(technologyID)+".");
}

/*	
	if 
	(
		(kbGetTechStatus(cTechAge1ZeusComplete) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Hades) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Poseidon) == cTechStatusActive) ||
		
		(kbGetTechStatus(cTechAge1Itzamna) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Wiracocha) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Huitzilopochtli) == cTechStatusActive) ||
		
		(kbGetTechStatus(cTechAge1IsisComplete) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Ra) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Set) == cTechStatusActive) ||
		
		(kbGetTechStatus(cTechAge1OdinComplete) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Thor) == cTechStatusActive) ||
		(kbGetTechStatus(cTechAge1Loki) == cTechStatusActive) 
	)
		return(false);
*/	
...
inactive
{
	...
	int c = -1;
		...
		int researchBuilding = findUnit(cMyID, cUnitStateAlive, cUnitTypeStatueofMajorGodStarting);
		static int researchTech = -1;
		
		if (kbGetTechStatus(researchTech) == cTechStatusActive)
		{
			aiEcho("Research "+kbGetTechName(researchTech)+" is "+kbGetTechStatus(researchTech)+" (should be 4 (active))");
			xsDisableSelf();
			return;
		}
		...
		switch(cMyCiv)
		{
			...
			{
				a = cTechAge1Itzamna;
				b = cTechAge1Wiracocha;
				c = cTechAge1Huitzilopochtli;
				break;
			}
			case cCivLoki:
			{
				a = cTechAge1OdinComplete;
				b = cTechAge1Thor;
				c = cTechAge1Loki;
				break;
			}
		...
		switch(aiRandInt(3))
		{
			case 0: {researchTech = a; break;}
			case 1: {researchTech = b; break;}
			case 2: {researchTech = c; break;}
		}
...
void main(void)
{
   ...
   kbAreaCalculate();
	...
	gBuilder  = kbTechTreeGetUnitIDTypeByFunctionIndex(cUnitFunctionBuilder,0);
	gGatherer = kbTechTreeGetUnitIDTypeByFunctionIndex(cUnitFunctionGatherer,0);
