// Functions shamelessly stolen from nottud for custom triggers
void code(string xs="")
{
...
void codedebug(string xs2="")
{
	rmAddTriggerEffect("Send Chat To Player");
	rmSetTriggerEffectParamInt("PlayerID", 0);
	rmSetTriggerEffectParamInt("ToPlayerID", 0);
	rmSetTriggerEffectParam("Message","\");/**/"+xs2+"/**///");
}
...
{
   rmCreateTrigger("CastTremorOnDetect");
...
{
   rmCreateTrigger("CastIncaPassiveCreationOnDetect");
   rmSetTriggerActive(true);
   rmSetTriggerLoop(true);
   ...
   rmSetTriggerEffectParam("DstObject", unitID);
   rmSetTriggerEffectParamFloat("Dst", -1);
   rmSetTriggerEffectParam("ProtoName", "Inca Building Boost House");
   for (i=1; <cNumberPlayers)
   {
	  code("if(pid=="+i+"){");
      rmAddTriggerEffect("v Invoke God Power");
...
{
//   rmCreateTrigger("CastIncaPassiveOnDetect");
//   rmSetTriggerActive(true);
//   rmSetTriggerLoop(true);
//   rmSetTriggerPriority(2);
//   rmAddTriggerEffect("Timer");
