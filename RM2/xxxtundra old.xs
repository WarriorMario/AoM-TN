void TrigEffect(string xs="")
{
	rmAddTriggerEffect("SetIdleProcessing"); 
	rmSetTriggerEffectParam("IdleProc", "true); "+xs+" trSetUnitIdleProcessing(true"); 
}

void TrigCondition(string xs3="")
{
	rmAddTriggerCondition("Timer"); 
	rmSetTriggerConditionParam("Param1","0==("+xs3+")");   
}

void CastTremorOnDetect(string unitID = " ")
{
   for (i=0; <cNumberPlayers)
   {
      rmCreateTrigger("CastTremorOnDetect"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmAddTriggerEffect("v 1 Target Protounit Query Start");
      rmSetTriggerEffectParam("DstObject", unitID);
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Sling Shot Wood Circular Shockwave");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("PowerName", "Tremor2");
      rmAddTriggerEffect("v Destroy");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
   }
}

void CastHealingGPOnBuilding(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastHealingGP"+i);
      rmSetTriggerActive(true);
      rmSetTriggerLoop(true);
	  rmAddTriggerCondition("Timer");
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "AN Healing Building");
	  rmAddTriggerEffect("v Convert");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "AN Vision");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "AN Healing 1");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "AN Healing 3");
      rmAddTriggerEffect("v Destroy");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
   }
}

void CastIncaPassiveCreationOnDetect(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      rmAddTriggerEffect("Timer");
      rmSetTriggerEffectParamInt("Param1", 1);
      rmAddTriggerEffect("v 1 Target Protounit Query Start");
      rmSetTriggerEffectParam("DstObject", unitID);
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "House American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
   }
}

void CastIncaPassiveCreationOnDetect1(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect1"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Temple American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect2(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect2"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Dock American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect3(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect3"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Armory American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect4(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect4"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Tower American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect5(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect5"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Native Training Grounds");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect6(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect6"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Forest Cottage");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect7(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect7"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Elite Training Grounds");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect8(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect8"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Fort");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect9(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect9"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Market American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect10(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect10"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Tower Mirror American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveCreationOnDetect11(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveCreationOnDetect11"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Wonder American Native");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassiveCreation");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
...
void CastIncaPassiveOnDetect(string unitID = " ")
{
   for (i=1; <cNumberPlayers)
   {
      rmCreateTrigger("CastIncaPassiveOnDetect"+i);
      rmSetTriggerActive(true);
      rmSetTriggerRunImmediately(true);
      rmSetTriggerLoop(true);
      rmSetTriggerPriority(2);
      ...
      rmSetTriggerEffectParamFloat("Dst", -1);
      rmSetTriggerEffectParamInt("PlayerID", i);
      rmSetTriggerEffectParam("ProtoName", "Inca Building Boost Target");
      rmAddTriggerEffect("v Invoke God Power");
      rmSetTriggerEffectParamInt("PlayerID", 0);
      rmSetTriggerEffectParam("PowerName", "IncaPassive");
      rmAddTriggerEffect("v 2 Target Protounit Query End");
   }
}
...
//	rmCreateTrigger("Snow_E");
	...
	rmSetTriggerConditionParam("ProtoUnit", "Statue Of Major God Starting");
...
*/
   ...
   if (MaxNumber<4)
   {
      if (MaxNumber>2)
      {
         for(i=3; <4)
         {
            ...
            rmSetTriggerEffectParamInt("Amount", -10000, false);
            rmAddTriggerEffect("Grant Resources");
            rmSetTriggerEffectParamInt("PlayerID", i, false);
   ...
   int centerUnitID=rmCreateObjectDef("Center Unit");
   rmAddObjectDefItem(centerUnitID, "Revealer to Player", 1, 0.0);
   rmSetObjectDefMinDistance(centerUnitID, 0.0);
   rmSetObjectDefMaxDistance(centerUnitID, 0.0);
   rmPlaceObjectDefAtLoc(centerUnitID, 0, 0.5, 0.5, 1);
   string unitID = ""+rmGetUnitPlaced(centerUnitID, 0);
   CastTremorOnDetect(unitID);
   CastHealingGPOnBuilding(unitID);
   CastIncaPassiveCreationOnDetect(unitID);
   CastIncaPassiveCreationOnDetect1(unitID);
   CastIncaPassiveCreationOnDetect2(unitID);
   CastIncaPassiveCreationOnDetect3(unitID);
   CastIncaPassiveCreationOnDetect4(unitID);
   CastIncaPassiveCreationOnDetect5(unitID);
   CastIncaPassiveCreationOnDetect6(unitID);
   CastIncaPassiveCreationOnDetect7(unitID);
   CastIncaPassiveCreationOnDetect8(unitID);
   CastIncaPassiveCreationOnDetect9(unitID);
   CastIncaPassiveCreationOnDetect10(unitID);
   CastIncaPassiveCreationOnDetect11(unitID);
   CastIncaPassiveOnDetect(unitID);
